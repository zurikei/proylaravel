...
volver [
    ...
    * /
    ...
    'entre'          => [
        ...
        'array'    => ': atributo tiene que tener entre: min -: ítems max.' ,
    ],
    ...
    'max' => [
        'numeric' => ': atributo no debe ser mayor a: máx.' ,
    ...
    'required_unless'       => 'El campo: atributo es obligatorio a menos que: otro esté en: values.' ,
